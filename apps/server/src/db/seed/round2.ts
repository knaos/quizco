  ...
  await prisma.question.createMany({
    data: [
      // Question 0: Test question
      {
        ...
        index: 0,
        realIndex: 0,
        questionText: "Подредете дните от седмицата",
        type: "CHRONOLOGY",
        points: 0,
        timeLimitSeconds: 360,
        content: {
          items: [
            { id: "w1", text: "Понеделник", order: 0 },
            { id: "w2", text: "Вторник", order: 1 },
            { id: "w3", text: "Сряда", order: 2 },
            { id: "w4", text: "Четвъртък", order: 3 },
            { id: "w5", text: "Петък", order: 4 },
            { id: "w6", text: "Събота", order: 5 },
            { id: "w7", text: "Неделя", order: 6 },
          ],
        },
        grading: "AUTO",
      },
