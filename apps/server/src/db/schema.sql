...
-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('CLOSED', 'MULTIPLE_CHOICE', 'OPEN_WORD', 'CROSSWORD', 'FILL_IN_THE_BLANKS', 'MATCHING', 'CHRONOLOGY', 'TRUE_FALSE', 'CORRECT_THE_ERROR');

-- CreateEnum
CREATE TYPE "RoundType" AS ENUM ('STANDARD', 'CROSSWORD', 'SPEED_RUN', 'STREAK');
