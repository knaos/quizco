  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-2xl mx-auto">
      <button
        ...
        className={`aspect-square md:aspect-auto md:h-24 rounded-3xl text-4xl font-black uppercase transition-all transform flex items-center justify-center shadow-2xl border-b-8 ${previewMode
